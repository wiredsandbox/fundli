...
from fundli.services.shared import parse_datetime
...
def test_parse_datetime():
    ...
    test_cases = [
        testCase(
            "2020-01-01T00:00:00Z", datetime(2020, 1, 1, 0, 0, 0, tzinfo=pytz.UTC)
        ),
        testCase(
            "2020-01-01T00:00:00-04:00",
            datetime(2020, 1, 1, 0, 0, 0, tzinfo=pytz.FixedOffset(-240)),
        ),
        testCase(
            "2020-01-01T00:00:00+04:00",
            datetime(2020, 1, 1, 0, 0, 0, tzinfo=pytz.FixedOffset(240)),
    ...
    for test_case in test_cases:
        ...
        assert got == test_case.expected, "expected: {}, got: {}".format(
